...
from lib.net import Hallucinator
...
class Normal(pl.LightningModule):
    ...
    def __init__(self, cfg):
        ...
        self.netG = Hallucinator(self.cfg, error_term=nn.SmoothL1Loss())
    ...
    def configure_optimizers(self):
        ...
        optim_params_N_B = [{
            "params": self.netG.netL.parameters(),
            "lr": self.lr_N
        }]
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        FB_tensor = {
            "render_B": batch["render_B"],
            "render_L": batch["render_L"]
        }

        self.netG.train()

        preds_B, preds_L = self.netG(in_tensor)
        error_NF, error_NB = self.netG.get_norm_error(preds_B, preds_L,
                                                      FB_tensor)
